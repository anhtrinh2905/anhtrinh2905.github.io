...
import { PROJECTS_DETAILS, PORJECTS_BASIC_INFO } from "@/lib/projectsPageInfo";
    ...
    return (
        <section className="w-full mt-10 md:mt-30 lg:mt-20 mb-30">
            <div className="flex flex-col justify-center items-center gap-5 mb-10 md:mb-20 px-10 md:px-20">
                <h2 className="uppercase">{PORJECTS_BASIC_INFO.title}</h2>
                <span className="max-w-3xl text-center text-white/80">{PORJECTS_BASIC_INFO.description}</span>
            </div>
